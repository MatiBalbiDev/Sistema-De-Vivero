function mostrarMapa() {
  ...
  let sucursales = [
    [-34.5221554, -58.7000067],
    [-34.527468, -58.708561],
    [-34.53040295302667, -58.70292272848468],
    [-34.52710594143552, -58.68587559181003],
    [-34.5134171387725, -58.70638836032645]
  ];
  ...
  for (let i = 0; i < sucursales.length; i++) {
    ...
    var marker = L.marker(sucursales[i], {
      icon: redIcon
    }).addTo(map).bindPopup('<b>' + sucursal + '</b>' + "</br>" + calle);
  }
